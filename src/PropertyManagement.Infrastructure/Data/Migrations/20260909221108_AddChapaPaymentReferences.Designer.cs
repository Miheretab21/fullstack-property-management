...
namespace PropertyManagement.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260909221108_AddChapaPaymentReferences")]
    partial class AddChapaPaymentReferences
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PropertyManagement.Domain.Entities.Property", b =>
                {
                    ...
                    b.Property<decimal>("TotalSquareMeters")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasDefaultValue(0m);
            ...
            modelBuilder.Entity("PropertyManagement.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<string>("ChapaPaymentReference")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("ChapaTransactionReference")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
